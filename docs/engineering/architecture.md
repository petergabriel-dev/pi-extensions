...
This repository publishes as `@lopezpetergabriel/pi-extensions@0.2.2`, one Pi package containing nine extensions, three skills, and two package-owned bundled agent definitions. It is source, not a separate Pi home.
