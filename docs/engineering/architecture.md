...
This repository publishes as `@lopezpetergabriel/pi-extensions@0.4.0`, one Pi package containing ten extensions, three skills, and two package-owned bundled agent definitions. It is source, not a separate Pi home.
