...
| ADR-0024 | Active | Design mode and design docs root | changing Design prompts, design scaffolds, build prompt composition, frontend component guidance, or bridge prompt recall |
