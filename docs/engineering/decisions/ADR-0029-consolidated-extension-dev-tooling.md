...
- Development separation costs seven nested manifests, five lockfiles, and five TypeScript configs (`docs/engineering/architecture.md:102-108`).
...
- Temporary: Until migration, seven manifests, five lockfiles, five TypeScript configs, and current bootstrap behavior remain supported project truth.
